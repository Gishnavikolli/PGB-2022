...
function JavaScript3() {
  ...
  const SameLevel=()=>window.history.go="/JavaScript3Quiz";
  return questions.length > 0 ? (
    ...
    >
      {currentIndex >= questions.length ? (
        ...
        <Link to="/JavaScript3Quiz"><button style={{marginLeft:"5%",backgroundColor:"white",width:"200px",padding:"8px",fontWeight:"bolder",borderRadius:"10px"}} type= "button" className='btn-next' onClick={SameLevel}>Try Again</button></Link>
        </>
        }
        </>
      ) : (
